...
"font: oblique 7pt \"DejaVu Sans\";"));
    ...
    {
        LocalPlayerWidget->setWindowTitle(QCoreApplication::translate("LocalPlayerWidget", "Form", nullptr));
        mp_labelAvatar->setText(QString());
#if QT_CONFIG(tooltip)
        mp_buttonEndTurn->setToolTip(QCoreApplication::translate("LocalPlayerWidget", "End of your turn", nullptr));
#endif // QT_CONFIG(tooltip)
        mp_buttonEndTurn->setStyleSheet(QString());
#if QT_CONFIG(tooltip)
        mp_buttonPass->setToolTip(QCoreApplication::translate("LocalPlayerWidget", "Do not react - you will lose a life point,", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        mp_buttonDiscard->setToolTip(QCoreApplication::translate("LocalPlayerWidget", "Discard cards before end of your turn.", nullptr));
#endif // QT_CONFIG(tooltip)
        mp_labelPlayerName->setText(QCoreApplication::translate("LocalPlayerWidget", "{PLAYERNAME}", nullptr));
    } // retranslateUi
