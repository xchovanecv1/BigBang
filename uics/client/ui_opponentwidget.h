...
"font: oblique 7pt \"DejaVu Sans\";"));
    ...
    {
        OpponentWidget->setWindowTitle(QCoreApplication::translate("OpponentWidget", "Opponent Widget", nullptr));
        mp_labelAvatar->setText(QString());
        mp_labelPlayerName->setText(QCoreApplication::translate("OpponentWidget", "{PLAYERNAME}", nullptr));
    } // retranslateUi
